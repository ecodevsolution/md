				...
				<tbody>
					...
					<tr>
						<td class="table-photo">
							<img src="../../img/banner/<?= $models->banner; ?>" alt="" data-toggle="tooltip" data-placement="bottom" title="Nicholas<br/>Barrett">
						</td>
						<td>
							<?= $models->tag; ?>
						</td>
						...
						<td class="table-icon-cell">
							<?= Html::a('', ['update','id'=>$models->idbannerads], ['class' => 'fa fa-pencil']) ?>													
						</td>
						<td class="table-icon-cell">
							<?= Html::a('', ['delete','id'=>$models->idbannerads], ['class' => 'fa fa-trash swal-btn-warning']) ?>																										
						</td>											
					</tr>	
					<?php endforeach; ?>
				</tbody>
