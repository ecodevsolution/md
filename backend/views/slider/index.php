				...
				<tbody>
					...
					<tr>
						<td class="table-photo">
							<img src="../../img/slider/<?= $models->slider_img; ?>" alt="" data-toggle="tooltip" data-placement="bottom" title="Nicholas<br/>Barrett">
						</td>
						<td>
							<?= $models->mainCategory->main_category_name; ?>
						</td>
						<td class="color-blue-grey-lighter"><?= $models->tag; ?></td>
						<td class="color-blue-grey-lighter"><?= $models->tag_highligt; ?></td>						
						<td class="table-icon-cell">
							<?= Html::a('', ['update','id'=>$models->idslider], ['class' => 'fa fa-pencil']) ?>													
						</td>
						<td class="table-icon-cell">
							<?= Html::a('', ['delete','id'=>$models->idslider], ['class' => 'fa fa-trash swal-btn-warning']) ?>																										
						</td>											
					</tr>	
					<?php endforeach; ?>
				</tbody>
