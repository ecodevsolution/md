				...
				<tbody>
					...
					<tr>
						<td class="table-photo">
							<img src="../../img/brand/<?= $models->brand_logo; ?>" alt="" data-toggle="tooltip" data-placement="bottom" title="Nicholas<br/>Barrett">
						</td>
						<td>
							<?= $models->brand_name; ?>
						</td>
						<td class="table-icon-cell">
							<?= Html::a('', ['update','id'=>$models->idbrand], ['class' => 'fa fa-pencil']) ?>													
						</td>
						<td class="table-icon-cell">
							<?= Html::a('', ['delete','id'=>$models->idbrand], ['class' => 'fa fa-trash swal-btn-warning']) ?>	
