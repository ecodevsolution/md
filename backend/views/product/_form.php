...
<div class="box-typical box-typical-padding">
	...
	<div class="panel panel-default">
        <div class="panel-heading"><h4><i class="glyphicon glyphicon-camera"></i> Product Upload</h4></div>
                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <?= $form->field($imgs, "[{$i}]title")->textInput(['maxlength' => 50]) ?>
                            </div>
							<div class="col-sm-12">
								<?= $form->field($imgs, "[{$i}]is_cover")->dropDownList(array('0' => 'Yes', '1' => 'No'),['prompt'=>'- Choose -']) ?>
                            </div>
                        </div><!-- .row -->
                    </div>
                </div>
