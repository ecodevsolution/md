				...
				<tbody>
					...
					<tr>
						<td class="table-photo">
							<img src="../../img/sale/<?= $models->sale_slider; ?>" alt="" data-toggle="tooltip" data-placement="bottom" title="Nicholas<br/>Barrett">
						</td>
						<td width="90%">
							<?= $models->tag; ?>
						</td>
						<td class="table-icon-cell">
							<?= Html::a('', ['update','id'=>$models->idbanner], ['class' => 'fa fa-pencil']) ?>													
						</td>
						<td class="table-icon-cell">
							<?= Html::a('', ['delete','id'=>$models->idbanner], ['class' => 'fa fa-trash swal-btn-warning']) ?>																										
						</td>											
					</tr>	
					<?php endforeach; ?>
				</tbody>
