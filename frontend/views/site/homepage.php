								...
								<div class="item">
									<div class="item-area">
										<div class="product-image-area">
											...
											<a href="catalog-<?= strtolower(str_replace(' ','_',$products->sku)); ?>-<?= strtolower(str_replace(' ','_',$products->title)); ?>" title="<?= $products->title; ?>" class="product-image">												
											<?php
										...
										<div class="details-area">
											<h2 class="product-name">												
												<a href="catalog-<?= strtolower(str_replace(' ','_',$products->sku)); ?>-<?= strtolower(str_replace(' ','_',$products->title)); ?>" title="<?= $products->title; ?>"><?= $products->title; ?></a>
											</h2>
											<div class="price-box">
												<?php
													if($products->discount > 0){
											...
											<div class="actions">
												<?= Html::a('Add to cart', ['./cart-add-'.$products->idproduk], ['class' => 'icon-cart addtocart'])?>
							...
							<div class="filter-products">
								<div class="products small-list">
									<div class="item">
										<div class="item-area">
											<div class="product-image-area">
												<a href="catalog-<?= strtolower(str_replace(' ','_',$models->sku)); ?>-<?= strtolower(str_replace(' ','_',$models->title)); ?>" title="<?= $products->title; ?>" class="product-image">	
												<?php
													$imgs = Image::find()
														->where(['product_id'=>$products->idproduk])
														->where(['is_cover'=>1])
