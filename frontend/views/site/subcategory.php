	                ...
	                <div class="accordion-inner">
	                    <ul>
	                        <li>
								<div class="accordion-group">
						            <div class="accordion-heading">
						                <a href="#collapseSubOne" data-toggle="collapse" class="accordion-toggle collapsed">
						                	Games
						                </a>
					                </div>
					                <div class="accordion-body collapse" id="collapseSubOne" style="height: 0px;">
						                <div class="accordion-inner">
						                    <ul>
...
<div class="search-result-container">
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="?r=site/singlepro">Sony Ericson Vaga</a></h3>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							<button class="btn btn-primary icon" data-toggle="dropdown" type="button" onMouseOver="this.style.backgroundColor='#0F0'" onMouseOut="this.style.backgroundColor='#575757'">
								<i class="fa fa-shopping-cart"></i>													
							</button>
							<button class="btn btn-primary" type="button" onMouseOver="this.style.backgroundColor='#0F0'" onMouseOut="this.style.backgroundColor='#a8a8a8'">Add to cart</button><!-- LOOPING -->
